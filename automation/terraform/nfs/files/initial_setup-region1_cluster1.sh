...
sudo hostnamectl set-hostname r1-nfs-server-01
...
## For Tor1 / Tor2 / Tor3
/mnt/nfs_shares/amq 10.70.0.0/24(rw,insecure,sync,no_all_squash,root_squash) \
                    10.70.64.0/24(rw,insecure,sync,no_all_squash,root_squash) \
                    10.70.128.0/24(rw,insecure,sync,no_all_squash,root_squash)
EXPORTS_EOF
