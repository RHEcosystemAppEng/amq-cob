...
sudo hostnamectl set-hostname nfs-server-dal-01
...
## For Dal1 / Dal2 / Dal3
/mnt/nfs_shares/amq 10.200.0.0/24(rw,insecure,sync,no_all_squash,root_squash) \
                    10.200.64.0/24(rw,insecure,sync,no_all_squash,root_squash) \
                    10.200.128.0/24(rw,insecure,sync,no_all_squash,root_squash)
EXPORTS_EOF
