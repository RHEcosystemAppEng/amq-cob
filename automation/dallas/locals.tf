locals {
  ...
  CLUSTER1_BROKER_01_USER_DATA_FILE       = "../broker/region2/cluster1/broker1_live1/initial_setup-01.sh"
  CLUSTER1_BROKER_02_USER_DATA_FILE       = "../broker/region2/cluster1/broker2_bak1/initial_setup-01.sh"
  CLUSTER1_BROKER_03_USER_DATA_FILE       = "../broker/region2/cluster1/broker3_live2/initial_setup-01.sh"
  CLUSTER1_BROKER_04_USER_DATA_FILE       = "../broker/region2/cluster1/broker4_bak2/initial_setup-01.sh"
  ...
  CLUSTER2_BROKER_05_USER_DATA_FILE       = "../broker/region2/cluster2/broker5_live3/initial_setup-01.sh"
  CLUSTER2_BROKER_06_USER_DATA_FILE       = "../broker/region2/cluster2/broker6_bak3/initial_setup-01.sh"
  CLUSTER2_BROKER_07_USER_DATA_FILE       = "../broker/region2/cluster2/broker7_live4/initial_setup-01.sh"
  CLUSTER2_BROKER_08_USER_DATA_FILE       = "../broker/region2/cluster2/broker8_bak4/initial_setup-01.sh"
