...
sudo hostnamectl set-hostname r2-nfs-server-01
...
## For Dal1 / Dal2 / Dal3
/mnt/nfs_shares/amq 10.75.0.0/24(rw,insecure,sync,no_all_squash,root_squash) \
                    10.75.64.0/24(rw,insecure,sync,no_all_squash,root_squash) \
                    10.75.128.0/24(rw,insecure,sync,no_all_squash,root_squash)
EXPORTS_EOF
